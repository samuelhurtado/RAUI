...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about wages and collective bargaining. \n"
    ...
    f"wages, compensation of employees, collective bargaining, employment conditions and benefits, etc."
    ...
    f"Agreement: 10% wage increase for industry workers over two years (Sentiment 8, Uncertainty 2). \n"
    f"Insufficient wages and overloads: reasons for the extension of the hospitality strike in Santa Cruz de Tenerife (Sentiment 3, Uncertainty 7). \n"
    f"Employers see no need for increased wages, citing survey: 80% of workers in the region are happy with their current working conditions (Sentiment 8, Uncertainty 3). \n"
    f"Ministry will inform wage negotiators about the profits declared by firms in their sector (Sentiment 5, Uncertainty 3). \n"
    f"The fight for increased wages in hospitality sector is getting hotter as the region debates its economic model (Sentiment 3, Uncertainty 7). \n"
    f"Wages growt in the region, but still at lower rate than the national average (Sentiment 6, Uncertainty 2). \n"
    f"Governor says teachers' salaries have gone down in real terms, calls for faster wage increases in upcoming agreement (Sentiment 4, Uncertainty 3). \n"
    f"Teachers want to regain their purchasing power, will ask for sharp wage increase in the upcoming negotiations (Sentiment 4, Uncertainty 4). \n"
    f"Teachers want to regain their purchasing power, are blowing up the negotiations, strike ahead (Sentiment 3, Uncertainty 7). \n"
    f"Teachers say they want to regain their purchasing power, but government replies average salary has increased 22% since 2018 (Sentiment 6, Uncertainty 3). \n"
