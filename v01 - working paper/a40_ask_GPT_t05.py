...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about prices of energy and other raw materials. \n"
    ...
    f"prices of energy and other raw materials, oil, natural gas, electricity, etc."
    ...
    f"Historical fall in the price of natural gas, caused by the increased LNG exports from USA (Sentiment 8, Uncertainty 2). \n"
    f"Milestone achieved: after the fall in the cost of solar power, it is now competitive with fossil fuels (Sentiment 8, Uncertainty 3). \n"
    f"Oil prices on the rise after Middle East tensions (Sentiment 2, Uncertainty 7). \n"
    f"Extreme uncertainty in prices of emissions, as announced regulatory changes are unexpectedly delayed (Sentiment 4, Uncertainty 9). \n"
    f"Battery and energy storage firms promise a revolution in electric generation because of cheaper solutions (Sentiment 7, Uncertainty 7). \n"
    f"The unexpected increase in electricity prices was caused by drought and low hydroelectric generation (Sentiment 3, Uncertainty 6). \n"
    f"Big fluctuations in the price of lithium as speculation dominates international markets (Sentiment 4, Uncertainty 8). \n"
    f"Strike in Brazilian mines causes increase in the international price of copper (Sentiment 3, Uncertainty 7). \n"
    f"Fast adoption of new transport technologies with lower emissions could reduce the global demand of oil, lowering energy prices, but timing and size of the effects are still unknown (Sentiment 8, Uncertainty 8). \n"
    f"Adoption of electric vehicles is causing scarcity in rare earths markets, which could lead to problems in other markets, including semiconductors (Sentiment 5, Uncertainty 8). \n"
