...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about the housing market. \n"
    ...
    f"the housing market, house prices, rents, accessibility to housing, residential construction, etc."
    ...
    f"The rise in rent is suffocating local commerce in central Barcelona: Small businesses will disappear (Sentiment 1, Uncertainty 8). \n"
    f"Home purchases accelerate their increase to 13.9% and mark the best February since 2007 (Sentiment 9, Uncertainty 2). \n"
    f"The signing of home mortgages slows its increase in Asturias to 4.7% in February (Sentiment 5, Uncertainty 4). \n"
    f"The region with the fastest growth of home mortgages in February: up 55.6% (Sentiment 8, Uncertainty 2). \n"
    f"President announces 23 billion over a decade to incentivize the construction of 150,000 small homes per year (Sentiment 7, Uncertainty 3). \n"
    f"44% of the homes sold in Alicante were purchased by foreigners, nearly triple the national average (Sentiment 6, Uncertainty 5). \n"
    f"The new housing decree of the regional Government usurps powers from city councils (Sentiment 3, Uncertainty 7). \n"
    f"Opposition will demand the appearance of the Minister of Housing in the Senate regarding intervention in the rental market (Sentiment 5, Uncertainty 5). \n"
    f"When your landlord raises the rent by 1,000 euros for a damp flat full of mould: We cannot live like this anymore (Sentiment 2, Uncertainty 7). \n"
    f"Households allocated 56% of their salary to paying rent in 2024, more than the previous year (Sentiment 4, Uncertainty 5). \n"
