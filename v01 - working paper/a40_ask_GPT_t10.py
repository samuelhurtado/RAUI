...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about confidence of agents and evolution of internal demand. \n"
    ...
    f"confidence of households and firms (particularly about consumption and investment), evolution of internal demand in the economy, etc."
    ...
    f"The four sectors with sizeable falls in business confidence in the second quarter: down 1.1% (Sentiment 3, Uncertainty 6). \n"
    f"One in three households in the region believes their financial situation has worsened over the past six months (Sentiment 3, Uncertainty 6). \n"
    f"Household consumption withstands the impact of inflation thanks to savings and the strength of the labor market (Sentiment 6, Uncertainty 7). \n"
    f"The Consumer Confidence Index reaches 89 points and stands above pre-pandemic levels (Sentiment 8, Uncertainty 2). \n"
    f"The Bank of Spain anticipates that GDP will contract in the second quarter because of low consumption and investment (Sentiment 2, Uncertainty 4). \n"
    f"72.2% of companies say prices will remain stable this quarter, the highest share since 2021 (Sentiment 7, Uncertainty 3). \n"
    f"Business confidence rises but fewer companies are created now than a year ago (Sentiment 7, Uncertainty 4). \n"
    f"Business confidence fell by 1.1% the region in the fourth quarter of the year (Sentiment 2, Uncertainty 2). \n"
    f"Significant rebound in business confidence (Sentiment 7, Uncertainty 2). \n"
    f"Companies have doubts about their foreign order books, and this could seriously affect investment (Sentiment 4, Uncertainty 8). \n"
