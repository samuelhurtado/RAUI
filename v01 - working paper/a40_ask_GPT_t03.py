...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about export markets, external demand, and growth of the global economy. \n"
    ...
    f"export markets, external demand, growth of the global economy, exports of goods and services, etc."
    ...
    f"World GDP grew 3.5% last year, after an anexpected push from emerging markets. Europe benefits: an increase of 20% in exports to Asia. (Sentiment 9, Uncertainty 1). \n"
    f"Emerging markets are leading global growth in 2024 (Sentiment 7, Uncertainty 2). \n"
    f"The fall in global trade slows down world GDP growth (Sentiment 3, Uncertainty 2). \n"
    f"IMF forecasts a high rate of global GDP growth next year, but the scenarios range from a 5% increase to a 1% fall (Sentiment 7, Uncertainty 9). \n"
    f"The fall in world demand is weighting down the projections of export manufacturers (Sentiment 3, Uncertainty 5). \n"
    f"Spanish international trade on the rise: exports to new markets provide a solid boost (Sentiment 7, Uncertainty 2). \n"
    f"Experts warn of possible fluctuations in export markets for European agriculture and food industries (Sentiment 5, Uncertainty 7). \n"
    f"Global economic instability and political conflicts are causing chaos in the markets: European exports to key markets could fall up to 40% (Sentiment 2, Uncertainty 8). \n"
    f"Energy crisis destabilizes markets: Spanish exports face unforseeable risks (Sentiment 2, Uncertainty 9). \n"
    f"The slow recovery of global trade opens oportunities and creates risks for European exports to emerging markets (Sentiment 5, Uncertainty 7). \n"
