...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about geopolitical tensions. \n"
    ...
    f"geopolitical tensions, armed conflicts, wars, diplomatic crises, military interventions, revolutions and coups, etc."
    ...
    f"Diplomatic crisis between Iran and Saudi Arabia: tensions over nuclear program (Sentiment 4, Uncertainty 8). \n"
    f"Israel and Palestine: more deaths in the escalation of violence in the Gaza Strip (Sentiment 1, Uncertainty 4). \n"
    f"Historic agreement between China and Taiwan: peaceful dialogue opens new avenues of cooperation (Sentiment 7, Uncertainty 5). \n"
    f"Military maneuvers on both sides of the border: the Korean powder keg (Sentiment 4, Uncertainty 8). \n"
    f"Negotiations for the peace agreement begin (Sentiment 7, Uncertainty 7). \n"
    f"Revolution in Myanmar: protesters defy military repression (Sentiment 3, Uncertainty 8). \n"
    f"One year without combat deaths: the international coalition has managed to stabilize the region and promotes sustainable development (Sentiment 9, Uncertainty 3). \n"
    f"Political collapse in Venezuela: internal tensions and international pressure (Sentiment 4, Uncertainty 6). \n"
    f"Mass protests in Georgia: the opposition accuses the government of electoral fraud (Sentiment 5, Uncertainty 7). \n"
    f"The peaceful resolution of the conflict in the South China Sea boosts regional cooperation (Sentiment 8, Uncertainty 4). \n"
