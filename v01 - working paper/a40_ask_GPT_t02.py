...
def analyze_text_with_llm(text):
    text_prompt = (
    f"This is a news article that talks about international trade, tariffs and commercial fragmentation. \n"
    ...
    f"international trade, tariffs, comercial fragmentation, global value chains, international transport of goods, protectionism, globalization, etc."
    ...
    f"Increased tariffs between USA and China set off a new phase of global trade wars (Sentiment 2, Uncertainty 6). \n"
    f"Europe looks for ways to protect its value chains in response to increasing global trade tensions (Sentiment 6, Uncertainty 6). \n"
    f"New tariffs undermine the stability of emerging markets (Sentiment 3, Uncertainty 7). \n"
    f"Technology giants warn: commercial disputes will have an impact on their supply chains (Sentiment 3, Uncertainty 6). \n"
    f"Chinese retaliation against USA tariffs heat up the trade war: increased probability of a global recession (Sentiment 3, Uncertainty 6). \n"
    f"South America rises as a new protagonist in the reconfigurd global value chains (Sentiment 7, Uncertainty 3). \n"
    f"Manufacturing firms are moving their operations to countries with lower import tariffs (Sentiment 7, Uncertainty 3). \n"
    f"India and Vietnam, winners of the trade war, as manufacturers look for more diversified sources (Sentiment 7, Uncertainty 3). \n"
    f"New trade agreements that reduced barriers are leading to more resilient and sustainable value chains (Sentiment 9, Uncertainty 1). \n"
    f"The collapse of global value chains threatens paralysis of the global economy, in an environment of uncontrolled increasing tensions (Sentiment 1, Uncertainty 8). \n"
